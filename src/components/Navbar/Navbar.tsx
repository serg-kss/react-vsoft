      ...
      <header className="w-full text-gray-700 bg-white shadow-sm body-font">
        <div className="container flex flex-col items-start p-5 mx-auto md:flex-row">         
            ...
            <div className="items-center h-full pl-6 ml-6 border-l border-gray-200">
               ...
               <Button action={logout} title={'Logout'} style={'px-4 py-2 text-xs font-bold text-white uppercase transition-all duration-150 bg-teal-500 rounded shadow outline-none active:bg-teal-600 hover:shadow-md focus:outline-none ease'}/>
            </div>
        </div>
    </header>
   );
